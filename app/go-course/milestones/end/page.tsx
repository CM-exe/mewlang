  ...
  return (
    <div className="theme-go">
      <div className="wrap">
        ...
        <p>
          <img className="mascot-right" src={img1.src} alt="The Mewlang cat, wearing glasses, looking confident" width="120" loading="lazy" />
        ...
        <p>
          <img className="mascot-right" src={img3.src} alt="The Mewlang cat, thinking, paw to chin" width="120" loading="lazy" />
        ...
        <ul>
          <li>
            <img className="mascot-left" src={img4.src} alt="The Mewlang cat, raising a paw for a high-five" width="120" loading="lazy" />
        ...
        <p>
          <img className="mascot-right" src={img5.src} alt="The Mewlang cat, beaming with delight" width="120" loading="lazy" />
